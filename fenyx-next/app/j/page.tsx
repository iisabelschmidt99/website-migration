...
export default async function ConceptJPage() {
  ...
  return (
    <div className="dg-page">
      ...
      {/* ── Timeline (g) ──────────────────────────────────────────── */}
      <TimelineCinematicG
        bestandImageSrc="/assets/concepts/j/bestandsmanagement.jpg"
        verwertungImageSrc="/assets/concepts/j/verwertung-lift.jpg"
        einrichtungImageSrc="/assets/concepts/j/einrichtung.jpg"
      />
