        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-12">
          ...
          <div>
            <ul className="space-y-3 text-sm mb-6">
              ...
              <li>
                <a
                  href="mailto:info@fenyx-office.com"
                  className="flex items-center gap-2 hover:text-signal transition-colors"
                  data-track-surface="footer"
                >
                  <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="flex gap-3">
              <a
                href="https://www.instagram.com/fenyx_offices/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 border border-white/15 flex items-center justify-center hover:border-signal hover:text-signal transition-colors"
                aria-label="Instagram"
                data-track-id="footer__social__instagram"
              >
              ...
              <a
                href="https://www.linkedin.com/company/fenyx-office/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 border border-white/15 flex items-center justify-center hover:border-signal hover:text-signal transition-colors"
                aria-label="LinkedIn"
                data-track-id="footer__social__linkedin"
              >
                ...
                {col.links.map((link) => (
                  <li key={link.href}>
                    <Link
                      ...
                      data-track-id={`footer__${col.title.toLowerCase().replace(/\s+/g, "_")}__${link.label.toLowerCase().replace(/\s+/g, "_")}`}
                    >
                      {link.label}
                    </Link>
                  </li>
          ...
          <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-xs text-white/40">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2">
              <Link
                ...
                className="hover:text-signal transition-colors"
                data-track-event="cta_click"
                data-track-id="footer__legal__impressum"
              >
                Impressum
              </Link>
              <Link
                ...
                className="hover:text-signal transition-colors"
                data-track-event="cta_click"
                data-track-id="footer__legal__datenschutz"
              >
                Datenschutz
              </Link>
              <CookieSettingsLink />
              <Link
                ...
                className="hover:text-signal transition-colors"
                data-track-event="cta_click"
                data-track-id="footer__legal__agb"
              >
                AGB
              </Link>
            </div>
