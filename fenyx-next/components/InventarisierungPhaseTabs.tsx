...
function HeadingBlock({
  ...
  return (
    <div className={`${wide ? "max-w-none" : "max-w-3xl"} mb-10 sm:mb-14`}>
      <h2
        id="tabs-heading"
        className="inv-section-heading text-3xl sm:text-4xl font-heading tracking-[-0.03em] mb-5 text-signal"
      >
        {heading}
      </h2>
      {introLead || introBody ? (
        ...
        <div className="sticky top-[72px] flex min-h-[calc(100vh-72px)] items-center py-12">
          <div className="inv-container w-full">
            ...
            <div className="grid items-center gap-8 lg:gap-14 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.25fr)]">
              ...
              <div className="relative w-full aspect-[4/3] lg:aspect-auto lg:h-[38rem] overflow-hidden">
                {tabs.map((tab, i) => (
                  <Image
                    key={tab.id}
                    src={tab.imageSrc}
