  ...
  return (
    ...
    >
      <div className="wf-padding-global">
        ...
        <div className="text-center wf-max-width-large wf-align-center mb-16 sm:mb-20">
          <h2
        ...
        <LifecycleTrack>
          ...
          {/* Kleine Zwischenkarte aus der Webflow-Vorlage */}
          <div className="max-w-md mx-auto mb-6 lg:mb-8 p-6 sm:p-8 bg-abyss-deep border border-white/10 text-white">
            <h3 className="text-h4 font-heading mb-2">Optimierte Flächennutzung</h3>
